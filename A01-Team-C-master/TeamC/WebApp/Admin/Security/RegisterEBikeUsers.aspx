<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterEBikeUsers.aspx.cs" Inherits="WebApp.Admin.Security.RegisterEBikeUsers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <ItemTemplate>
            <tr style="">
                ...
                <td>
                    ...
                    <asp:Label Text='<%# Bind("UserType") %>' runat="server" ID="UserTypeLabel" />
                </td>
                <td>
    ...
    <asp:ObjectDataSource ID="UnregisteredUsersDataSource" runat="server" OldValuesParameterFormatString="original_{0}" 
                          SelectMethod="ListAllUnregisteredUsers" TypeName="WebApp.Admin.Security.RegistrationController"></asp:ObjectDataSource>
</asp:Content>
